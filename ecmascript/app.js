...
// async function mensajeAsync(){ //sin try catch
//     console.log('esperando')
//     const result = await mensaje()
//     return result
// }

async function mensajeAsync(){ //con try catch
    try{
        console.log('esperando')
        const result = await mensaje()
        return result
...
mensajeAsync().then(result => { console.log(result) }).catch(error => { console.log(error) }) //una forma
mensajeAsync() // otra forma
